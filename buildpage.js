...
function request() {
    ...
    Http.open("GET", "https://script.google.com/macros/s/AKfycbz3LWtcS6LT1xuq6_xawepVwO46aOmxgvTr4bsf8Ts1yuP_mdf0v6bvdtVrGCVy70JEXA/exec?requesttype=itemsrequest&category="+category);
    Http.send();
    var responsejson;
