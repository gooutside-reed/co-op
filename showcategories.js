...
function request() {
    ...
    Http.open("GET", "https://script.google.com/macros/s/AKfycbzzprtOE14qxnCU0VSGnO2qiPjPV4thiC2YP4GlOUPv0ERV6ZJwijbm6JRBwXGEdgQp4g/exec?requesttype=categoryrequest");
    Http.send();
    var responsejson;
