...
function getOrder(){
    ...
    Http.open("GET", "https://script.google.com/macros/s/AKfycbw4CeteAymScHdgf0kaFc4zn2-qXSE2lmJSP6wTCy_-jKaHbFVNcdFkiNdHyooJxbIbgQ/exec?requesttype=utilityrequest&ordernumber="+onumber);
    Http.send();
    var responsejson;
